...
interface MergedCurvesRenderer {
    setCurve(index: number, controlPoints: THREE.Vector3[], color: number, flightData?: FlightData | null): void;
    setCurveColor(index: number, color: number, flightData?: FlightData | null): void;
...
interface MergedPanesRenderer {
    ...
    updatePaneOnCurve?(index: number, curve: THREE.CatmullRomCurve3, t: number, epsilon: number, tiltMode: string): void;
...
export class Flight {
     ...
     * Set animation speed
     */
    public setAnimationSpeed(speed: number, options: AnimationSpeedOptions = {}): void {
