...
export class PanesShader {
     ...
     */
    public setCurveControlPoints(index: number, controlPoints: THREE.Vector3[]): void {
     ...
     */
    public setPaneColor(index: number, color: THREE.Color | THREE.ColorRepresentation): void {
        if (index < 0 || index >= this.maxPanes) return;
     ...
     */
    public setTexture(texture: THREE.Texture | null, atlasInfo: AtlasInfo | null = null): void {
        if (!this.material || !this.material.uniforms) return;
